...
| **Appendices** | Gemma Replication | `src/experiments/gemma_replication.py` | ✅ Verified | Standalone script |
...
| | McNemar Test | `src/reporting.py` | ✅ Verified | `perform_mcnemar` with file finding logic |
...
| | Error Analysis | `src/evaluation.py` | ✅ Verified | `analyze_errors` exports JSON |
